...
export const canisterId = process.env.CREDSEG_ICP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./credseg_icp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the credseg_icp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./credseg_icp_backend.did.js")._SERVICE>}
 */
