...
export const canisterId = process.env.FLIGHT_API_HTTP_REQUEST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./flight_api_http_request.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the flight_api_http_request canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./flight_api_http_request.did.js")._SERVICE>}
 */
