...
export const canisterId = process.env.CREDSEG_ICP_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./credseg_icp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the credseg_icp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./credseg_icp_frontend.did.js")._SERVICE>}
 */
